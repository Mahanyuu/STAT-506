...
manager_df_USD_Adult$Currency <- droplevels(manager_df_USD_Adult$Currency)
...
manager_df_USD_Adult[as.numeric(as.numeric(manager_df_USD_Adult$Year_of_Overall_Experience)) >= as.numeric(manager_df_USD_Adult$Year_of_Field_Experience), ]
...
#drop impossibility between age and year of overall experience, which means the upper bound of year range minus the lower bound of year in overall experience <18
manager_df_USD_Adult <- manager_df_USD_Adult %>%
  filter(as.numeric(Age)==1 & as.numeric(Year_of_Overall_Experience) < 3 | as.numeric(Age)==2 & as.numeric(Year_of_Overall_Experience) < 4 | as.numeric(Age)==3 & as.numeric(Year_of_Overall_Experience) < 7 | as.numeric(Age)==4 & as.numeric(Year_of_Overall_Experience) < 8)
count_2 <- data.frame(
  count_USD = nrow(manager_df_USD),
...
count_3
```
According to https://dqydj.com/average-median-top-salary-percentiles/, I choose the minimun annual salary is the 1% salary percentile for United States in 2023 and the maximum annual salary is the 99% salary percentile for United States in 2023.
